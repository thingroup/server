...
import com.jerry.gamemarket.service.PayService;
import com.jerry.gamemarket.utils.serializer.JsonUtils;
import com.jerry.gamemarket.utils.serializer.MathUtils;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse notify(String notifyData) {
        ...
        if(!MathUtils.isEqual(orderDTO.getOrderAmount().doubleValue() , payResponse.getOrderAmount())) {
            ...
            throw new GameException(ResultEnum.PAY_MONEY_NOT_EQUAL);
        }
